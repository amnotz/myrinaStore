...
<!-- **************************************bootstrap************************************** -->
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/imageshow.css">
...
<nav class="navbar navbar-default navbar-fixed-top" id="testnavbar">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo site_url('front_controller/main') ?>">Myrina </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="guntab ">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo site_url('front_controller/profile') ?>">Profile</a></li>
         <li><a href="<?php echo site_url('front_controller/statuspage') ?>">StatusPage</a></li>
...
<body background="../../imges/night10g.jpg">
    ...
    <div  class="modal-content" id="backGmodal">
      ...
      <div class="modal-footer">
        <div class="row">
          ...
          <button class="btn btn-warning"style="margin-right:17px">Save</button>
        </div>
      </div>
      </div>
